...
Performance (avg - seconds) & 10.14 & \textbf{4.72} \\
Performance (max - seconds) & 624.25 & \textbf{264.101} \\
Implementation Size (avg - Lines of Code) & 72.88 & \textbf{69.81} \\
Implementation Size (max - Lines of Code) & 2322 & 2142 \\
Implementation Performance (avg - ms) & \textbf{58.49} & 60.75 \\
Implementation Performance (max - ms) & 473.14 & \textbf{465.043} \\
\bottomrule
\end{tabular}
}
\end{table}
...
\end{figure}
 ...
 \fi
 Table~\ref{tbl:stats} shows that
