...
\begin{figure*}[!t]
\centering
\subfloat[Performance Comparison]{\includegraphics[width=3.5in]{overhead}
\label{fg:performance}}
\hfil
\subfloat[Size of Synthesized
Implementations]{\includegraphics[width=3.5in]{loc}
\label{fg:size}}
\hfil
\subfloat[Performance of Synthesized Implementations]{\includegraphics[width=3.5in]{performance}
...
\mike{Can we make any claims about why the new synthesis procedure is slower during execution?  Is it the factorization performed by the inductive approach?}
