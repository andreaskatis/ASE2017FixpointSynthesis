...
\begin{proof}
  ...
  $F(s_0) \Rightarrow \exists i. A(s_0, i) \land \neg Q(s_0, i)$
  by Corollary~\ref{cor:subset}. Given that $F(s_0)$ holds, let $i_0$
  be such that $A(s_0, i_0)$ and $\neg Q(s_0, i_0)$. Since $Q$ is the
  region of validity for $\phi$ on Line 3, we have
  $F(s_0) \land A(s_0, i_0) \Rightarrow \neg \exists s'. G_T(s, i, s')
  \land F(s')$ by Corollary~\ref{cor:subset}. Since $F(s_0)$ and
  $A(s_0, i_0)$ hold we have
...
\begin{proof}
  ...
  by Corollary~\ref{cor:subset}. Rewritten,
