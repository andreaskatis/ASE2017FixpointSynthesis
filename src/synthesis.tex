...
In general,
the witness is described through the use of nested \textit{if-then-else} blocks, following the structure of the Skolem witnesses, where the conditions are subsets of the antecedent of
