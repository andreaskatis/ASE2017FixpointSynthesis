...
What remains is the loop continuation at line 16.  Assuming $\forall s . \viable(s) \implies F(s)$, we must demonstrate $\forall s . \viable(s) \implies F(s) \land \lnot W(s)$.  We first examine the definition of viability: 
\[
