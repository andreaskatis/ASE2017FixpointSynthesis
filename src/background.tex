...
\caption{A simple Assume-Guarantee Contract. \john{Was this example used in previous papers? I am not sure if it matters or not, but it might be more compelling to come up with another simple example. Reviewers may bulk if we keep hitting them over the head with the same figure.}}
\label{fg:agcontract}
\end{figure}
