...
More recently, Preiner \textit{et al}. presented their work on model synthesis~\cite{preiner2017counterexample}, %that constructs candidate witnesses constructed and their validity is checked with respect to the specification. Internally, 
