...
is found, we construct a witness that is directly translated into a C implementation \john {does it matter that it is a C implementation? shouldn't we just note that we can create "an implementation"?}. We implemented the algorithm in the \jkind model checker, and exercised it against contracts written using
